...
import {tryFn, locationToYaml, mapCoordToYalm} from "../../utils/utils";
...
const MapWindow = (props) => {
    ...
    playerPos = locationToYaml(playerPos);
    ...
    const yalmPointer = mapCoordToYalm(pointer);

    return <Window name="MapWindow" type="window" width={width} height={height} id={id} onClick={onClick} active={active}>
        <div className="map-pointer-location">X:{yalmPointer.x} Y:{yalmPointer.y}</div>
